...
```
cd existing_repo
git remote add origin http://192.168.0.32/gitlab-instance-b9319445/cloudtool.git
git branch -M main
...
- [ ] [Set up project integrations](http://192.168.0.32/gitlab-instance-b9319445/cloudtool/-/settings/integrations)
